...
namespace lab2
{
    class Program
    {
        static void Main()
        {
            Tuple<int, int, int, char> function(int[] massive, string str)
            {
                Array.Sort(massive);
                var k = Tuple.Create(massive[massive.Length - 1], massive[0], massive.Sum(), str[0]);
                return k;
            }

            function(new int[] {45, 5, 15}, "line");

            int LocalFunctionChecked()
            {
                try
                {
                    checked
            ...
            LocalFunctionChecked();
            LocalFunctionUnchecked();
        }
        ...
        static void task4()
        {
            ...
            (byte a, byte b) left = (10, 5);
            (byte a, byte b) right = (5, 10);
            if (left == right)
            {
            ...
            (int, byte) korteshik = (134, 10);
            int a = korteshik.Item1;
            byte b = (byte)korteshik.Item2;
        }
    }
}